...
const metadata = {
    ...
    description: "Create high-fidelity cinematic videos using Stable Diffusion. Private GPU rendering with Supabase Edge Functions.",
    icons: {
